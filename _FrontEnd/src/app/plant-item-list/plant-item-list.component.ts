...
@Component({
  selector: 'app-plant-item-list',
  templateUrl: './plant-item-list.component.html',
  styleUrls: ['./plant-item-list.component.css']
})
export class PlantItemListComponent implements OnInit {
